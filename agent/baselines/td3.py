...
def main():
    ...
    csv_path, model_path = output_paths(args, "td3", months)
    best_config_csv_path = best_config_path(args, "td3", months)
    monthly_best_paths = monthly_best_config_paths(args, "td3", months)
    logger = CsvLogger(csv_path)
    monthly_loggers = make_monthly_loggers(args, "td3", months)
    viz = make_training_visdom(args, "td3", months)
    best_cost = math.inf
